...
public class ConsoleToFile : MonoBehaviour
{
    ...
    public void Log(string logString, string stackTrace, LogType type)
    {
        if (fileName == "")
        {
            string path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Desktop) + "/Unity_Logs";
            System.IO.Directory.CreateDirectory(path);
            string formattedDate = DateTime.Now.ToString().Replace("/", "_").Replace(":", "-");
